      ...
      <div className='container-master parallax-content'>
        ...
        <div className="parallax">
            <div className="overlay">
               <div className="parallax-title">Regularização de Documentos</div>
               <button className="btn-primario" onClick={(e) => { e.preventDefault(); toggleServicePopup(); }}>Solicitar Serviço</button>
            </div>
         </div>
        ...
        <div className='container-work'>
          <div className='container-master'>
            ...
            <div className='box-main-work'>
              <img className='img-como-trabalhamos' src={ImgComoTrabalhamos} alt="Trabalho em grupo" />
              <div className='box-work-text'>
                ...
                <p className='text-p'>Já pensou regularizar seu veículo sem sair de casa ou trabalho? Clique no botão abaixo e conheça nossos serviços.</p>
